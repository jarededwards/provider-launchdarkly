...
PROJECT_REPO := github.com/jarededwards/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_VERSION := 2.9.4
export TERRAFORM_PROVIDER_DOWNLOAD_NAME := terraform-provider-launchdarkly
export TERRAFORM_NATIVE_PROVIDER_BINARY := terraform-provider-launchdarkly_v2.9.4_x5
